...
import org.example.project.service.command.my_debt.MyDebtCommandHandler;
...
public class SaveDebtCommandHandlerFactory {
    private final List<SaveDebtCommandHandler> handlers;
